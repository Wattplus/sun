        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="group relative overflow-hidden rounded-2xl bg-white/10 backdrop-blur-sm shadow-xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
            <div className="aspect-[4/3] w-full overflow-hidden">
              <img
                src="/lovable-uploads/29a0fbb4-3379-413d-ae00-258f0ba2e117.png"
            ...
            <div className="p-6 bg-gradient-to-t from-black/80 via-black/50 to-transparent absolute inset-0 flex flex-col justify-end text-white">
              <h3 className="text-2xl font-bold mb-4 animate-fade-in">Villa Provençale</h3>
              ...
              <div className="space-y-3 text-white/90">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-green-400 font-bold">680€/an</span>
                </div>
              </div>
          ...
          <div className="group relative overflow-hidden rounded-2xl bg-white/10 backdrop-blur-sm shadow-xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
            <div className="aspect-[4/3] w-full overflow-hidden">
              <img
                src="/lovable-uploads/0b51d6d7-66aa-4644-93ee-f8abae4c972f.png"
            ...
            <div className="p-6 bg-gradient-to-t from-black/80 via-black/50 to-transparent absolute inset-0 flex flex-col justify-end text-white">
              <h3 className="text-2xl font-bold mb-4 animate-fade-in">Villa Contemporaine</h3>
              ...
              <div className="space-y-3 text-white/90">
                ...
                <div className="flex items-center gap-2">
                  <span className="font-semibold">Économies:</span>
                  <span className="text-green-400 font-bold">1250€/an</span>
                </div>
              </div>
