    ...
    <div className="space-y-8 p-6 bg-gradient-to-br from-background to-background/80">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <motion.div 
          ...
          className="space-y-8"
        >
          <Card className="p-6 bg-glass-gradient backdrop-blur-sm border-primary/10 hover:bg-glass-gradient-hover hover:border-primary/20 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 group">
        ...
        <motion.div 
          ...
          transition={{ duration: 0.5, delay: 0.2 }}
        >
          <Card className="p-6 h-full bg-glass-gradient backdrop-blur-sm border-primary/10 hover:bg-glass-gradient-hover hover:border-primary/20 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 group">
            <h2 className="text-xl font-semibold mb-4 bg-gradient-to-r from-primary to-primary-light bg-clip-text text-transparent group-hover:scale-105 transition-transform">
              Aperçu des Leads
            </h2>
            <LeadsOverview />
