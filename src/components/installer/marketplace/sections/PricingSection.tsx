    ...
    <Card className="p-6 bg-white/80 backdrop-blur-sm border border-primary/10 shadow-lg">
      <div className="space-y-4">
        <div className="flex items-center gap-2 border-b border-primary/10 pb-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-secondary">Tarifs des leads</h3>
        ...
        <div className="space-y-3">
          <div className="relative transform hover:scale-105 transition-all duration-300">
            ...
            <div className="p-4 rounded-lg relative overflow-hidden transition-all duration-300 bg-gradient-to-br from-white to-primary/5 border border-primary/10 shadow-lg hover:shadow-primary/20">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex flex-col gap-1.5 mt-2">
                      <span className="text-sm flex items-center gap-2 text-secondary">
          ...
          <div className="p-4 rounded-lg relative overflow-hidden hover:scale-105 transition-all duration-300 bg-gradient-to-br from-white to-secondary/5 border border-secondary/10 shadow-lg hover:shadow-secondary/20">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
          ...
          <div className="p-4 rounded-lg relative overflow-hidden hover:scale-105 transition-all duration-300 bg-gradient-to-br from-white to-accent/5 border border-accent/10 shadow-lg hover:shadow-accent/20">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="text-base font-medium bg-gradient-to-r from-accent to-primary text-transparent bg-clip-text">
                    Lead professionnel
                  </span>
                  <div className="flex flex-col gap-1 mt-1">
                    <span className="text-sm text-muted-foreground flex items-center gap-1">
              ...
              <div className="text-2xl font-bold bg-gradient-to-r from-accent to-primary text-transparent bg-clip-text">
                59€
              </div>
            </div>
          </div>
