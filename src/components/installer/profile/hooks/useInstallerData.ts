...
import type { InstallerFormData, InstallerData, VisibilitySettings } from "../types/installer"
      ...
      try {
        ...
        if (installerData) {
          ...
          setFormData({
            ...
            visibility_settings: (installerData.visibility_settings as VisibilitySettings) || defaultVisibilitySettings,
          })
        }
      } catch (error) {
